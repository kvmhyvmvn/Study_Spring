...
public class MemberController {
	...
	public String reset(MemberVO vo) {
		...
		if (name == null) {
			...
			vo.setName(name);
			// 임시 비번을 생성한 후 DB의 회원정보로 저장, 임시 비번을 이메일로 보내준다.
			String pw = UUID.randomUUID().toString(); // dsallk234-akdsjlfj346-asdf
			pw = pw.substring(pw.lastIndexOf("-") + 1); // asdf
	...
	// id: SCYSmhnMP1qmMtw8TywW
	// secret: r479bCOhZG
	private String KAKAO_ID = "59d3cd1090a07a85d369cdb7c7f5b951";
	private String NAVER_ID = "SCYSmhnMP1qmMtw8TywW";
	private String NAVER_SECRET = "r479bCOhZG";
	...
	public String naverCallback(String code, String state, HttpSession session) {
		...
		if (json.getString("resultcode").equals("00")) {
			...
			// 별칭이 있으면 별칭을, 없으면 이름을 name 필드에 담으려고 한다
...
//			msg.append("location='").append(common.appURL(request)).append(match);
//		} else {
//			// 로그인 안 됨
