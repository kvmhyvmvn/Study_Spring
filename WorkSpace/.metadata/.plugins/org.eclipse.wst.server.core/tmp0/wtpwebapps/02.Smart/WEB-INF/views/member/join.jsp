...
<body>
			...
			<tr>
				...
				<td>
					<div class="row input-check align-items-center">
						...
						<div class="col-auto">아이디는 영문 소문자나 숫자 조합 5자~10자</div>
						<div class="desc"></div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="row input-check align-items-center">
						...
						<div class="col-auto">비밀번호는 영문 대/소문자나 숫자 조합 5자~10자</div>
						<div class="desc"></div>
					</div>
				</td>
			</tr>
	...
	$('.check-item').on('keyup', function(e){
		$(this).removeClass("ckecked-item") // 중복확인했음 클래스 삭제
		// 아이디에서 엔터시 중복 확인 처리하기
