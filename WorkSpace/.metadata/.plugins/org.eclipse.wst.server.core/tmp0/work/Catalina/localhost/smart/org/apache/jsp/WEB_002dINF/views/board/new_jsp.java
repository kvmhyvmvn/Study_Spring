 ...
 * Generated at: 2023-06-30 08:53:54 UTC
...
public final class new_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<h3 class=\"my-4\">방명록 글쓰기</h3>\r\n");
      ...
      out.write("	\r\n");
      out.write("		$('body *').on('drop', function(e) {\r\n");
      ...
      out.write("		 */\r\n");
      out.write("\r\n");
      out.write("		$('.file-drag').on({\r\n");
      out.write("			'dragover dragleave drop' : function(e) {\r\n");
      out.write("				e.preventDefault();\r\n");
      out.write("				//드래그오버시 입력태그에 커서가 있을때처럼 보여지게\r\n");
      out.write("				if (e.type == 'dragover')\r\n");
      out.write("					$(this).addClass('drag-over')\r\n");
      out.write("				else\r\n");
      out.write("					$(this).removeClass('drag-over')\r\n");
      out.write("			},\r\n");
      out.write("			'drop' : function(e) {\r\n");
      out.write("				console.log(e.originalEvent.dataTransfer.files)\r\n");
      out.write("				var files = e.originalEvent.dataTransfer.files;\r\n");
      out.write("				for(var i=0; i<files.length; i++) {\r\n");
      out.write("					// 폴더는 담지않는다\r\n");
      out.write("					if(files[i].type == \"\") {\r\n");
      out.write("						alert(\"폴더는 첨부할 수 없습니다.\")\r\n");
      out.write("					}else {\r\n");
      out.write("						fileList.setFile(files[i]);\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("			}\r\n");
      out.write("		})\r\n");
